...
//on enchaine une erosion suivi d'une dilatation
Erosion4(imOutSeuil,imOutErosion);
Dilatation4(imOutErosion,imOutDilatation);
char* imgOuvert("09Ouverture4.pgm");
imOutSeuil.save(cNomImgOut);
imOutDilatation.save(imgOuvert);
